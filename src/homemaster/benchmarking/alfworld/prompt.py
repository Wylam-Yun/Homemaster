...
def _format_tool_choice_guidance() -> str:
    return "\n".join([
        "- Use robot_go_to for any target you need to approach: movable objects, receptacles, furniture, appliances, containers, and switch/toggle objects.",
        "- Do not guess many source locations or ALFWorld navigation names. If you need an object, place, tool, or container, call robot_go_to with that target.",
