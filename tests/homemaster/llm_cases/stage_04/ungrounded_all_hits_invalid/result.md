# Stage 04 Grounding Context - ungrounded_all_hits_invalid
...
[
  {
    ...
    "anchor_type": "table",
    "display_text": "厨房餐桌",
    "viewpoint_id": "missing_viewpoint",
...
```json
{
  ...
  "runtime_state_summary": {
    ...
    "grounding_reason": "no reliable executable memory hit; planner should explore/search",
    "needs_exploratory_search": true
  },
  "world_summary": {
    "room_ids": [
