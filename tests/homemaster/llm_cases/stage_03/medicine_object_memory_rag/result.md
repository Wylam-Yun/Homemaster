...
Provider: {'provider_name': 'Mimo', 'model': 'mimo-v2-pro', 'protocol': 'anthropic', 'elapsed_ms': 27254.692499998782, 'attempts': [{'key_index': 1, 'status_code': 200, 'elapsed_ms': 27254.692499998782}]}
...
```text
{
  "query_text": "药盒在桌子那边，medicine box, pill box",
  "target_category": null,
  "target_aliases": ["药盒", "药品盒", "medicine box", "pill box"],
  "location_terms": ["桌子那边"],
  "source_filter": ["object_memory"],
  "top_k": 5,
  "excluded_memory_ids": [],
...
[
  {
    "document_id": "object_memory:mem-medicine-2",
    "score": 0.6810574673155294,
    "rank": 1
  },
  {
    "document_id": "object_memory:mem-medicine-1",
    "score": 0.6576476155589809,
    "rank": 2
  }
]
```
  ...
  "hits": [
    {
      ...
      "dense_score": 0.6576476155589809,
    ...
    },
    {
      ...
      "bm25_score": 0.705785870552063,
      "dense_score": 0.6810574673155294,
      "metadata_score": 0.25,
