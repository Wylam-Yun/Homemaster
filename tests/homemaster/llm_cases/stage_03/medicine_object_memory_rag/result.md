...
Provider: {'provider_name': 'Mimo', 'model': 'mimo-v2-pro', 'protocol': 'anthropic', 'elapsed_ms': 21299.705458000062, 'attempts': [{'key_index': 1, 'status_code': 200, 'elapsed_ms': 21299.705458000062}]}
...
```text
{
  "query_text": "药盒 pill box 桌子那边",
  "target_category": null,
  "target_aliases": ["药盒", "pill box"],
  "location_terms": ["桌子"],
  "source_filter": ["object_memory"],
  "top_k": 5,
  "excluded_memory_ids": [],
...
[
  {
    "document_id": "object_memory:mem-medicine-2",
    "score": 0.4814494550228119,
    "rank": 1
  },
  {
    "document_id": "object_memory:mem-medicine-1",
    "score": 0.20984995365142822,
    "rank": 2
  }
]
```
...
[
  {
    "document_id": "object_memory:mem-medicine-2",
    "score": 0.6695071462590261,
    "rank": 1
  },
  {
    "document_id": "object_memory:mem-medicine-1",
    "score": 0.6440351277536,
    "rank": 2
  }
]
```
  ...
  "hits": [
    {
      ...
      "bm25_score": 0.20984995365142822,
      "dense_score": 0.6440351277536,
    ...
    },
    {
      ...
      "bm25_score": 0.4814494550228119,
      "dense_score": 0.6695071462590261,
      "metadata_score": 0.25,
