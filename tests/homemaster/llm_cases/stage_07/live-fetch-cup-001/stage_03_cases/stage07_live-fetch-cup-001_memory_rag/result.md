# Stage 03 Memory RAG - stage07_live-fetch-cup-001_memory_rag

Status: PASS

Provider: {'provider_name': 'Mimo', 'model': 'mimo-v2-pro', 'protocol': 'anthropic', 'elapsed_ms': 22131.259624999984, 'attempts': [{'key_index': 1, 'status_code': 200, 'elapsed_ms': 22131.259624999984}]}
...
```json
{
  "case_name": "stage07_live-fetch-cup-001_memory_rag"
}
```
