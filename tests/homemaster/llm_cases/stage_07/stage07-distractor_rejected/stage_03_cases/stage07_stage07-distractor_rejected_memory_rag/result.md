# Stage 03 Memory RAG - stage07_stage07-distractor_rejected_memory_rag

Status: PASS

Provider: {'provider_name': 'Mimo', 'model': 'mimo-v2-pro', 'protocol': 'anthropic', 'elapsed_ms': 24600.006750000375, 'attempts': [{'key_index': 1, 'status_code': 200, 'elapsed_ms': 24600.006750000375}]}
...
```json
{
  "case_name": "stage07_stage07-distractor_rejected_memory_rag"
}
```
...
[
  {
    ...
    "text": "物体记忆。目标类别: cup。目标类别别名: 水杯、杯子、cup。别名: 水杯、杯子。历史位置: 厨房操作台。房间: kitchen。房间别名: 厨房、kitchen。锚点类型: counter。锚点别名: 台面、柜台、counter。可观察视角: kitchen_counter_viewpoint。置信度: medium。记忆状态: confirmed。最近确认时间: 2026-04-12T12:00:00Z。",
    "metadata": {
  ...
  },
  {
    ...
    "text": "物体记忆。目标类别: cup。目标类别别名: 水杯、杯子、cup。别名: 水杯。历史位置: 储物间搁架。房间: pantry。房间别名: 储物间、pantry。锚点类型: shelf。锚点别名: 搁架、架子、shelf。可观察视角: pantry_shelf_viewpoint。置信度: low。记忆状态: stale。最近确认时间: 2026-04-03T12:00:00Z。",
    "metadata": {
      "source_type": "object_memory",
      "memory_id": "mem-cup-2",
      "object_category": "cup",
...
[
  {
    "document_id": "object_memory:mem-cup-1",
    "score": 0.6835317417201486,
    "rank": 1
  },
  {
    "document_id": "object_memory:mem-cup-2",
    "score": 0.6159461620747501,
    "rank": 2
  }
]
```
