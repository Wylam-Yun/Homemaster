# Stage 03 Memory RAG - stage07_stage07-check_medicine_stale_recover_memory_rag

Status: PASS

Provider: {'provider_name': 'Mimo', 'model': 'mimo-v2-pro', 'protocol': 'anthropic', 'elapsed_ms': 20183.136749999903, 'attempts': [{'key_index': 1, 'status_code': 200, 'elapsed_ms': 20183.136749999903}]}
...
```json
{
  "case_name": "stage07_stage07-check_medicine_stale_recover_memory_rag"
}
```
...
[
  {
    ...
    "text": "物体记忆。目标类别: medicine_box。目标类别别名: 药盒、药箱、medicine_box、medicine。别名: 药盒、药箱。历史位置: 厨房药柜。房间: kitchen。房间别名: 厨房、kitchen。锚点类型: cabinet。锚点别名: 柜子、药柜、cabinet。可观察视角: kitchen_cabinet_viewpoint。置信度: high。记忆状态: confirmed。最近确认时间: 2026-04-15T09:00:00Z。",
    "metadata": {
  ...
  },
  {
    ...
    "text": "物体记忆。目标类别: medicine_box。目标类别别名: 药盒、药箱、medicine_box、medicine。别名: 药盒。历史位置: 客厅边桌。房间: living_room。房间别名: 客厅、living room、living_room。锚点类型: table。锚点别名: 桌子、餐桌、table。可观察视角: living_side_table_viewpoint。置信度: medium。记忆状态: confirmed。最近确认时间: 2026-04-19T08:30:00Z。",
    "metadata": {
      "source_type": "object_memory",
...
[
  {
    "document_id": "object_memory:mem-medicine-2",
    "score": 0.6745474338531494,
    "rank": 1
  },
  {
    "document_id": "object_memory:mem-medicine-1",
    "score": 0.43699416518211365,
    "rank": 2
  }
]
```
...
[
  {
    "document_id": "object_memory:mem-medicine-2",
    "score": 0.6921792853832335,
    "rank": 1
  },
  {
    "document_id": "object_memory:mem-medicine-1",
    "score": 0.6803325487605275,
    "rank": 2
  }
]
```
