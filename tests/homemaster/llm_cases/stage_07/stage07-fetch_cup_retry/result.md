# Stage 07 Run - stage07-fetch_cup_retry
...
```json
{
  ...
  "runtime_memory_root": "var/homemaster/runs/stage07-fetch_cup_retry/memory",
  "case_dir": "tests/homemaster/llm_cases/stage_07/stage07-fetch_cup_retry",
...
```json
{
  ...
  "evidence_bundle": {
    "task_id": "stage07-fetch_cup_retry",
    "evidence_refs": [
      {
        "evidence_id": "verification:stage07-fetch_cup_retry:1",
        "evidence_type": "verification_result",
        "source_id": "verification-1",
        "subtask_id": null,
        "memory_id": null,
        "location_key": null,
        "created_at": "2026-04-29T04:57:16Z",
        "summary": "观察到水杯"
      },
      {
        "evidence_id": "verification:stage07-fetch_cup_retry:2",
        "evidence_type": "verification_result",
      ...
      {
        "evidence_id": "verification:stage07-fetch_cup_retry:3",
        "evidence_type": "verification_result",
      ...
      {
        "evidence_id": "verification:stage07-fetch_cup_retry:4",
        "evidence_type": "verification_result",
      ...
      {
        "evidence_id": "verification:stage07-fetch_cup_retry:5",
        "evidence_type": "verification_result",
      ...
      {
        "evidence_id": "skill_result:stage07-fetch_cup_retry:1:navigation",
      ...
      {
        "evidence_id": "observation:stage07-fetch_cup_retry:1",
      ...
      {
        "evidence_id": "skill_result:stage07-fetch_cup_retry:2:operation",
        "evidence_type": "skill_result",
        "source_id": "skill-2",
        "subtask_id": null,
        "memory_id": null,
      ...
      {
        "evidence_id": "observation:stage07-fetch_cup_retry:2",
        "evidence_type": "observation",
        "source_id": "skill-2",
        "subtask_id": null,
        "memory_id": null,
      ...
      {
        "evidence_id": "skill_result:stage07-fetch_cup_retry:3:navigation",
        "evidence_type": "skill_result",
        "source_id": "skill-3",
        "subtask_id": null,
        "memory_id": null,
      ...
      {
        "evidence_id": "observation:stage07-fetch_cup_retry:3",
        "evidence_type": "observation",
        "source_id": "skill-3",
        "subtask_id": null,
        "memory_id": null,
      ...
      {
        "evidence_id": "skill_result:stage07-fetch_cup_retry:4:operation",
        "evidence_type": "skill_result",
        "source_id": "skill-4",
        "subtask_id": null,
        "memory_id": null,
      ...
      {
        "evidence_id": "observation:stage07-fetch_cup_retry:4",
        "evidence_type": "observation",
        "source_id": "skill-4",
        "subtask_id": null,
        "memory_id": null,
      ...
      {
        "evidence_id": "skill_result:stage07-fetch_cup_retry:5:navigation",
        "evidence_type": "skill_result",
        "source_id": "skill-5",
        "subtask_id": null,
        "memory_id": null,
      ...
      {
        "evidence_id": "observation:stage07-fetch_cup_retry:5",
        "evidence_type": "observation",
        "source_id": "skill-5",
        "subtask_id": null,
        "memory_id": null,
      ...
      {
        "evidence_id": "trace_event:stage07:stage07-fetch_cup_retry",
        "evidence_type": "trace_event",
        "source_id": "stage07:stage07-fetch_cup_retry",
        "subtask_id": null,
        "memory_id": null,
        "location_key": null,
        "created_at": "2026-04-29T04:57:16Z",
  ...
  "memory_commit": {
    "object_memory_path": "var/homemaster/runs/stage07-fetch_cup_retry/memory/object_memory.json",
    "fact_memory_write_count": 2,
    "task_record_write_count": 1,
    "commit_log": {
      "commit_id": "commit:stage07-fetch_cup_retry",
      "task_id": "stage07-fetch_cup_retry",
      "object_memory_update_count": 1,
      "fact_memory_write_count": 2,
