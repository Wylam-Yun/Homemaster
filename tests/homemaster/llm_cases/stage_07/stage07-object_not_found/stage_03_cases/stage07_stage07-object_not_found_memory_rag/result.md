# Stage 03 Memory RAG - stage07_stage07-object_not_found_memory_rag

Status: PASS

Provider: {'provider_name': 'Mimo', 'model': 'mimo-v2-pro', 'protocol': 'anthropic', 'elapsed_ms': 20513.866166000298, 'attempts': [{'key_index': 1, 'status_code': 200, 'elapsed_ms': 20513.866166000298}]}
...
```json
{
  "case_name": "stage07_stage07-object_not_found_memory_rag"
}
```
