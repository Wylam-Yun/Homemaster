...
- Result: PASS
- Case: stage07_fetch_cup_retry-1778332685_task_understanding
- Provider: Mimo
- Model: mimo-v2-pro
- Protocol: anthropic
...
```json
{
  "case_name": "stage07_fetch_cup_retry-1778332685_task_understanding",
  "required_checks": [
...
````json
{
  ...
  "location_hint": null,
  "success_criteria": ["机器人成功取到水杯并交付给用户"],
