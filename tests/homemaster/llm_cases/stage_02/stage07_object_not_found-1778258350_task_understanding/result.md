...
- Result: PASS
- Case: stage07_object_not_found-1778258350_task_understanding
- Provider: Mimo
- Model: mimo-v2-pro
- Protocol: anthropic
...
```json
{
  "case_name": "stage07_object_not_found-1778258350_task_understanding",
  "required_checks": [
...
````json
{
  ...
  "location_hint": null,
  "success_criteria": ["遥控器被成功找到并交付给用户"],
